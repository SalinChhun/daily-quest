...
import { updateQuestProgress } from "@/actions/db";
...
export default function FriendQuest() {
	...
	const handleApproved = async (id: string) => {
		try {
			await updateQuestProgress(id, { is_completed: true });
			...
			toast.error("Fail to mark this quest completed. " + (error instanceof Error ? error.message : "Unknown error"));
		}
	};
